...
public class AppearanceConstants {
	...
	public static final Font fontSmall = new Font("Times New Roman", Font.BOLD,18);
	public static final Font fontSmallest = new Font("Times New Roman", Font.BOLD,14);
	public static final Font fontMedium = new Font("Times New Roman", Font.BOLD, 22);
	public static final Font fontLarge = new Font("Times New Roman", Font.BOLD, 30);
